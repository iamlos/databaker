...
class Dimension(object):
    ...
    # this is done with this call because table.headers[number] takes "funcs" in append_dimension (it shouldn't), which are lambda functions only in debug dimensions
